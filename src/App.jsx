...
const defaultAgents = {
  ...
  coder: {
    name: "Code Expert",
    systemPrompt: "You are an expert programmer. Provide detailed code examples and explanations when asked about programming topics. You have access to Sandpack React for interactive code examples. When providing JavaScript or React code examples, you can make them interactive by using the code block format. Users can run your code examples directly in the chat interface.",
    avatar: "faCode",
    isDefault: true
  },
  creative: {
...
function App() {
  ...
  // Handle mobile input focus - scroll chat container to make input visible
  useEffect(() => {
    if (isMobile) {
      if (isInputFocused && chatContainerRef.current) {
        // Add the mobile-input-focused class to the chat container
        chatContainerRef.current.classList.add('mobile-input-focused');
        ...
        // Remove the class when input is not focused
        chatContainerRef.current.classList.remove('mobile-input-focused');
      }
    }
